...
<div class="container mx-auto px-4">
    ...
    <h1 class="text-2xl font-bold mb-6">床土への肥料使用登録</h1>
    ...
    <form action="{{ route('record.fertilizer_usage.storeSoil') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        ...
        {{-- 床土 (soil_id) --}}
        <div class="mb-4">
            <label for="soil_id" class="block text-gray-700 text-sm font-bold mb-2">床土名</label>
