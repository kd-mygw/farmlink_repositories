...
@section('title','種苗への肥料使用登録')
@section('content')
<div class="container mx-auto px-4">

    <h1 class="text-2xl font-bold mb-6">種苗への肥料使用登録</h1>
    ...
    <form action="{{ route('record.fertilizer_usage.storeSeed') }}" method="POST" class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4">
        @csrf
        ...
        {{-- 種苗 (seed_id) --}}
        <div class="mb-4">
            <label for="seed_id" class="block text-gray-700 text-sm font-bold mb-2">種苗名</label>
            <select name="seed_id" id="seed_id"
                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700"
                    required>
                <option value="">選択してください</option>
