...
@section('title','種苗への農薬使用 登録')
@section('content')
<div class="container mx-auto px-4">

    <h1 class="text-2xl font-bold mb-6">種苗への農薬使用 登録</h1>
    ...
    {{-- フォーム開始 --}}
    <!-- 送信先ルートを「storeSeed」に変更 -->
    <form action="{{ route('record.pesticide_usage.storeSeed') }}" method="POST" 
