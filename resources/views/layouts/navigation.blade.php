<nav x-data="{ open: false }" class="bg-green-700 dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="text-yellow-100 text-xl font-bold tracking-wide">
                        FARMLINK
                    </a>
                </div>
